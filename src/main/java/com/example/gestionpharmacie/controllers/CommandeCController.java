...
import com.example.gestionpharmacie.entities.*;
...
public class CommandeCController {
    ...
    public String createCommandeC(ModelMap modelMap) {
        List<Client> clientsVue=clientService.getAllClients();
        modelMap.addAttribute("clientsVue",clientsVue);
        List<Livreur> livreursVue=livreurService.getAllLivreurs();
        modelMap.addAttribute("livreursVue",livreursVue);
